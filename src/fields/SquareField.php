...
namespace trendyminds\square\fields;

use trendyminds\square\Square;
use trendyminds\square\assetbundles\squarefieldfield\SquareFieldFieldAsset;
...
class SquareField extends Field
{
    ...
    {
        return Craft::t('square', 'Square Products');
    }
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
        ...
        Craft::$app->getView()->registerAssetBundle(SquareFieldFieldAsset::class);
        ...
        Craft::$app->getView()->registerJs("$('#{$namespacedId}-field').SquareSquareField(" . $jsonVars . ");");

        // Render the input template
        return Craft::$app->getView()->renderTemplate(
            'square/_components/fields/SquareField_input',
            [
                'name' => $this->handle,
